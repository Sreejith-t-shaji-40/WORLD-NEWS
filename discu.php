...
.base-timer__label {
  ...
  font-size: 48px;
    ...
    <body>
        ...
        <div class="fleft"><img src="cover.png" height="80" width="301" right="0px" />
        <h1 style="color:#51ff0d;font-size:30px;">
       WELCOME  <?php include 'world_connection.php';
       if($_SESSION['user_session'] == 'user')
     {
     $username=$_SESSION['username'];
     echo $username;
    } ?>
     <BR>to the online discussion forum
      
      </h1>
      </div>
        <div class="fright"><!--div id="new" style="visibility: hidden"><h2 style="color:#51ff0d;font-size:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; DISCUSSION ENDED</h2></div-->
          <div id="enter_text">
     ...
     <div class="ftop"><h1 style="color:#51ff0d;font-size:30px;">
     <?php 
